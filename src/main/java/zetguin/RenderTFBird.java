...
import zetguin.ModZetguin;;


public class RenderTFBird extends RenderLiving
{
	private final ResourceLocation textureLoc = new ResourceLocation("zetguin:textures/model/penguin.png");

	
	public RenderTFBird(RenderManager renderManagerIn)
	{
		super(renderManagerIn, new ModelTFPenguin(), 0.5F);
	}
	
	/*
    public RenderTFBird(RenderManager renderManagerIn, ModelBase par1ModelBase, float par2, String textureName)
    {
        super(renderManagerIn, par1ModelBase, par2);
        
		textureLoc = new ResourceLocation(ModZetguin.MODEL_DIR + textureName);
    }
    */
    ...
    protected float getWingRotation(EntityTFBird par1EntityTFBird, float time)
    {
        ...
        return (float) ((Math.sin(var3) + 1.0F) * var4);
    }
     ...
     */
    public void doRender(EntityTFBird par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
